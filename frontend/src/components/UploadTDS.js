...
export default function UploadTDS() {
  const [file, setFile] = useState(null);
  const [docType, setDocType] = useState('TDS'); // Default for Customer PO
  ...
  return (
   <div className="main-content">
      <div className="container mt-5">
         <Toaster />
         <h3 className="text-center mb-4">Upload TDS</h3>
         ...
         <div className="mb-3">
            <select className="form-control" value={docType} onChange={(e) => setDocType(e.target.value)}>
               ...
               <option value="TDS">Form 16</option>
            </select>
         </div>
